...
/**
 * Enum class [Names] representing the names of Python functions
...
enum class Names(val value: String) {
    ...
    /**
     * [SEARCH_WITH_URL] is a function in Python that allows searching for video details using a YouTube URL.
     */
